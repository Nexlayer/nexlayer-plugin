...
- `.claude-plugin/marketplace.json` entries carry `category: deployment`, matching the vocabulary in Anthropic's official catalog
...
- `patches/0002`: scrubbed a real-shaped account identifier from the registry example and removed a dead internal-tool link
